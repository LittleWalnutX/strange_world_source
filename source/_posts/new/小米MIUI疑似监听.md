...
![](小米MIUI疑似监听/v2-ecfc4238c6c89503f786a5c23c873172_b.jpg)
...
![](小米MIUI疑似监听/v2-1a483ee23b2bd7f9254e73a0e9e2c464_b.jpg)

**查看app组件 可以发现确实使用了天御组件**

![](小米MIUI疑似监听/v2-b02b62e9b64a3c41ba1113a1d0d5ebbb_b.jpg)

**data目录文件如下：**

![](小米MIUI疑似监听/v2-476dec7ba04881e73510f8a07c0b6371_b.jpg)

![](小米MIUI疑似监听/v2-6d5cad2ec1a4ae26da5a3939be484b19_b.jpg)

**有趣的是，在databases文件夹里一个riskscan开头的文件里找到了这样一段话，**

**而下面则是一些app包名，大多是一些Xposed模块，推断这些应该是风险扫描app结果。**

![](小米MIUI疑似监听/v2-d9546905f414c41e6caf1954afe4f175_b.jpg)
...
![](小米MIUI疑似监听/v2-a79178b606086592909cde130a240ca5_b.jpg)

**在应用商店里下了一个某中心，查询库文件如图，使用了腾讯乐固。**

![](小米MIUI疑似监听/v2-9cf37d1e105b8bf2148b04652a883dcb_b.jpg)

![](小米MIUI疑似监听/v2-45b8001902782794a86bf47f913c2882_b.jpg)

![](小米MIUI疑似监听/v2-b7b4d74940695a1cc8df2b89a2218557_b.jpg)

**两个库都指向了同一个腾讯安全产品，而这是产品页的描述，细品一下令人后背发凉。**

**[由于作者上传长图，且较为模糊]** **因此笔者在不影响原文内容的情况下， 再次提供PC网页的截图。**

![](小米MIUI疑似监听/v2-728653bdfc01769b79ba1174c7e54eb9_b.jpg)
